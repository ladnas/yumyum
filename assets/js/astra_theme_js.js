...
(astraSmoothScroll = function (e, t) {
  ...
  (function () {
          ...
          for (let e = 0; e < l.length; e++) {
            ...
            for (link = 0, len = r.length; link < len; link++)
              null !== r[link].getAttribute("href") &&
                (r[link].getAttribute("href").startsWith("#") ||
                  -1 !== r[link].getAttribute("href").search("#")) &&
                (!r[link].parentElement.classList.contains(
                  "menu-item-has-children"
                ) ||
                  (r[link].parentElement.classList.contains(
                    "menu-item-has-children"
          ...
          if (t && e) {
            ...
            if (void 0 === n) a.style.display = "none";
              ...
              for (l = 0, r = s.length; l < r; l++)
                s[l].addEventListener("focus", L, !0),
                  s[l].addEventListener("blur", L, !0),
                  s[l].addEventListener("click", b, !0);
            }
          }
        }
      });
    ...
    astra.is_scroll_to_top &&
      ...
      (r = document.getElementById("ast-scroll-top")),
