            ...
            _ = (function () {
              ...
              return (
                ...
                (g.add = function (t, e, n) {
                  var s;
                  return (
                    (s = e ? t * l[p(e)] : d(t) ? t.$ms : f(t, this).$ms),
                    f(this.$ms + s * (n ? -1 : 1), this)
                  );
                }),
            ...
            (u.tz = function (t, e) {
              ...
              (u.offsetName = function (t) {
                var e = this.$x.$timezone || i.tz.guess(),
                  n = a(this.valueOf(), e, { timeZoneName: t }).find(function (
                    t
                  ) {
            ...
            (u.startOf = function (t, e) {
              ...
              (i.tz = function (t, e, n) {
                ...
                var c = (function (t, e, n) {
                    ...
                    return i === r
                      ? [s, i]
                      : [t - 60 * Math.min(i, r) * 1e3, Math.max(i, r)];
    ...
    (() => {
            ...
            if (-1 === p(i, u)) {
              const s = f(u),
                i =
                  ...
                  1e3 *
                    (3600 * (a.hour - o.hour) + 60 * (a.minute - o.minute))),
                r = c.duration(i),
                l = d(e.options.display.time_symbols),
                p = ` ${r.get("hours")}${l.hour}:${r.get("minutes")}${
                  l.minute
                } `;
      ...
      window.njtWhatsApp = {
        createButton: function (t, e) {
                        ...
                        (() => {
                          ...
                          return (
                            ...
                            t.setAttribute(
                              ...
                              "online" == i
                                ? `color: ${
                                    "#fff" == n.styles.textColor ||
                                    "#ffffff" == n.styles.textColor
                                      ? "#d5f0d9"
                                      : n.styles.textColor
                                  }; opacity: ${
                                    "#fff" == n.styles.textColor ||
                      ...
                      t.appendChild(
                        (() => {
                          ...
                          return (
                            ...
                            (t.innerHTML =
                              "online" === i ? n.i18n.online : n.i18n.offline),
                            t
                          );
                        })()
                      ),
            ...
            u.appendChild(
              (() => {
                ...
                return (
                  ...
                  t.setAttribute(
                    "style",
                    "online" == i ? "color: " + n.styles.textColor : ""
                  ),
              ...
              (() => {
                ...
                t.setAttribute("id", "nta-wa-gdpr"),
                  ...
                  (t.onchange = function (t) {
                    if (
                      t.target.checked &&
                      (h("nta-wa-gdpr", "accept", 30), "" != m("nta-wa-gdpr"))
                    ) {
                ...
                return (
                  s.setAttribute("for", "nta-wa-gdpr"), s.appendChild(e), s
                );
              })()
            );
          ...
          l.setAttribute(
            ...
            (l.onclick = function (t) {
              if (n.gdprStatus && !m("nta-wa-gdpr"))
                return (
                  t.preventDefault(),
                  (c.style.background = "red"),
                  void (c.style.color = "#fff")
                );
              v(this, {
            ...
            "online" == i &&
              (l.style.backgroundColor = n.styles.backgroundColor),
            l.appendChild(o),
            l.appendChild(u),
            t.appendChild(l),
        ...
        createWidget: function (t, e) {
          ...
          r.setAttribute("class", "wa__btn_popup_icon"),
            (r.style.background = s.backgroundColor);
                ...
                ? (r.classList.remove("wa__active"),
                  ...
                  r.classList.contains("wa__lauch") &&
                    (s = setTimeout(function () {
                      r.classList.remove("wa__pending"),
                        r.classList.remove("wa__lauch");
                    }, 400)))
                          ...
                          return (
                            ...
                            (e.onclick = function () {
                              v(this, {
                                ...
                                enabledGoogle:
                                  n.options.analytics.enabledGoogle,
                                enabledGoogleGA4:
          ...
          var l =
            ...
            f =
              ...
              l +
              '<span class="wa__popup_tooltiptext-ninja-mb">NINJATEAM</span></span>';
          "ON" === s.isShowPoweredBy &&
            ...
            "ON" === s.isShowScroll &&
              ((c.style.maxHeight = parseInt(s.scrollHeight) + "px"),
